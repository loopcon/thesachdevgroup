...
<section id="location-banner">
    <div class="location-banner-image">
        <img src="assets/image/locations-banner/banner-gt (1).webp" alt="Banner">
    </div>
</section>
...
<div class="container">
    <div class="location-text">
        <h1>Galaxy Toyota</h1>
        <p>Galaxy Toyota, located in Delhi, is a trusted Toyota dealership offering a wide range of the latest Toyota cars. Galaxy Toyota is known for its fantastic offers and excellent customer service, making it easier for customers to own their favorite Toyota models. They also provide top-notch after-sales services for a seamless car buying experience.</p>
    </div>
