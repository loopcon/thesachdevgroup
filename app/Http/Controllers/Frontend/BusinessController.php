...
class BusinessController extends Controller
{
    ...
    {   
        ...
        $return_data['showrooms'] = Showroom::select('id', 'our_business_id', 'name', 'name_color', 'name_font_size', 'name_font_family','slider_image','slider_showroom_name','slider_showroom_color','slider_showroom_font_size','slider_showroom_font_family','image','rating','number_of_rating')->where('our_business_id', $business->id)->get();
