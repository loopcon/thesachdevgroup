                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-2">
                                ...
                                @if(isset($record->address_icon) && $record->address_icon)
                                    <img src="{{url('public/uploads/used_car/addressIcon/'.$record->address_icon)}}" width="50">
                                @endif  
                            ...
                            <div class="col-md-4 mt-2">
                                ...
                                @if(isset($record->contact_icon) && $record->contact_icon)
                                    <img src="{{url('public/uploads/used_car/contactIcon/'.$record->contact_icon)}}" width="50">
                                @endif  
                            ...
                            <div class="col-md-4 mb-3 mt-2">
                                ...
                                @if(isset($record->email_icon) && $record->email_icon)
                                    <img src="{{url('public/uploads/used_car/emailIcon/'.$record->email_icon)}}" width="50">
                                @endif  
                            ...
                            <div class="col-md-4 mt-2">
                                ...
                                <input type="email" class="form-control" value="{{isset($record->email) ? $record->email : old('email')}}" name="email" id="email" required>
                            ...
                            <div class="col-md-3 mt-2">
                                <label for="facility_title_font_color" class="form-label">Facility Title Font Color</label>
                                <input type="text" class="form-control colorpicker" value="{{isset($record->facility_title_font_color) ? $record->facility_title_font_color : old('facility_title_font_color')}}" name="facility_title_font_color" id="facility_title_font_color">
                            </div>
                            ...
                            <div class="col-md-4 mt-2">
                                ...
                                @if(isset($record->lets_connect_image) && $record->lets_connect_image)
                                    <img src="{{url('public/uploads/used_car/letsConnectImage/'.$record->lets_connect_image)}}" width="50">
                                @endif  
