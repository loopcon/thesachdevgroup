                ...
                <div class="container-fluid">
                    <div class="form-row">
                        ...
                        <div class="col-md-3 text-end">
                            <a href="javascript:void(0);" class="btn btn-info btn-sm" id="check">{{__('Check All')}}</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="javascript:void(0);" class="btn btn-danger btn-sm float-right" id="uncheck">{{__('Uncheck All')}}</a>
                        </div>
                    </div>
                </div>
            </div>
