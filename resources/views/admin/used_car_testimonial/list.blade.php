    ...
    <div class="content">
        ...
        <div class="card">
            <div class="col-sm-12  text-end">
                <a href="{{ route('used-car-testimonial-create') }}" class="btn btn-primary float-right adm-table-addbtn">Add</a>
            </div>
            <div class="card-body">
...
<script type="text/javascript">
    $(function () {
        var table = $('.table').DataTable({
            ...
            serverSide: true,
            // scrollX: true,
            ajax: "{{ route('used-car-testimonial-datatable') }}",
            columns: [
    ...
    $(document).on('click', '.delete', function() {
        ...
        return new swal({
            title: "",
            text: "{{__('Are you sure? Delete this Used Car Testimonial!')}}",
