...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form action="@if(isset($record->id)) {{ route('used-car-testimonial-update', array('id' => encrypt($record->id))) }} @else{{ route('used-car-testimonial-store') }} @endif" method="POST" class="service-center-testimonial-form" enctype="multipart/form-data" data-parsley-validate="">
                        @csrf
                        <div class="row">
                            <div class="col-md-4 adm-brand-errorbox">
                                <label for="used_car_id" class="form-label">Used Car<span class="text-danger">*</span></label>
                                <select class="form-control select2" name="used_car_id" id="used_car_id" required>
                            ...
                            <div class="col-md-4 mt-2 mb-3">
                                ...
                                @if(isset($record->image) && $record->image)
                                    <img src="{{url('public/uploads/used_car_testimonial/'.$record->image)}}" width="50">
                                @endif  
                        ...
                        <div class="box-footer">
                            ...
                            <a href="{{ route('used-car-testimonial') }}" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
