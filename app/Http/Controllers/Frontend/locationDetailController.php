...
class locationDetailController extends Controller
{
    ...
    {
        $return_data = array();     
        $return_data['our_location'] = $ourLocation = Our_location::first();
        ...
        $return_data['service_center'] = ServiceCenter::select('id','name','slug','business_id','name_color','name_font_size','name_font_family','image', 'address', 'address_font_color','address_font_size','address_font_family','contact_number','contact_font_color','contact_font_size','contact_font_family','email','email_font_color','email_font_size','email_font_family','map_link')->get();
        ...
        $return_data['meta_title'] = isset($ourLocation->meta_title) && $ourLocation->meta_title ? $ourLocation->meta_title : NULL;
        $return_data['meta_description'] = isset($ourLocation->meta_description) && $ourLocation->meta_description ? $ourLocation->meta_description : NULL;
        $return_data['meta_keyword'] = isset($ourLocation->meta_keyword) && $ourLocation->meta_keyword ? $ourLocation->meta_keyword : NULL;
