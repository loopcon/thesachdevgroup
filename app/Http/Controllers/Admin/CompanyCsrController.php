        ...
        if(isset($has_permission) && $has_permission)
        {
            if($has_permission->read_permission == 1 || $has_permission->full_permission == 1)
            {
                ...
                if(isset($company_csr->id) && $company_csr->id)
                {
                    ...
                    $fields = array('title','title_color','title_font_size','title_font_family','description','description_font_color','description_font_size','description_font_family','left_title','left_title_color','left_title_font_size','left_title_font_family','left_description','left_description_font_color','left_description_font_size','left_description_font_family');
