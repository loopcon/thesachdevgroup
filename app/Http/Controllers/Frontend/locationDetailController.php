...
class locationDetailController extends Controller
{
    ...
    public function locationDetail()
    {
        ...
        $return_data['body_shops'] = Body_shop::select('id','business_id','image','name','name_color','name_font_size','name_font_family','address','address_font_size','address_font_family','address_font_color','email','email_font_size','email_font_family','email_font_color','contact_number','contact_font_size','contact_font_family','contact_font_color')->get();
