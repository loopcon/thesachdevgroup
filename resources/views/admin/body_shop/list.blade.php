        ...
        <div class="content">
            ...
            <div class="card">
                <div class="col-sm-12  text-end">
                    <a href="{{ route('bodyShopCreate') }}" class="btn btn-primary float-right adm-table-addbtn">Add</a>
                </div>
                <div class="card-body">
...
$(document).on('click', '.delete', function() {
    ...
    return new swal({
        title: "",
        text: "{{__('Are you sure? Delete this Body Shop!')}}",
