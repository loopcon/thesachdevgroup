...
ALTER TABLE `our_locations` ADD `meta_title` VARCHAR(255) NULL DEFAULT NULL AFTER `title_font_family`, ADD `meta_keyword` TEXT NULL DEFAULT NULL AFTER `meta_title`, ADD `meta_description` TEXT NULL DEFAULT NULL AFTER `meta_keyword`;
...
-- Disha : 17-10-2024 11:06 AM
ALTER TABLE `used_cars` ADD `description` TEXT NULL DEFAULT NULL AFTER `name_font_family`, ADD `description_font_size` VARCHAR(255) NULL DEFAULT NULL AFTER `description`, ADD `decription_font_family` VARCHAR(255) NULL DEFAULT NULL AFTER `description_font_size`, ADD `description_font_color` VARCHAR(255) NULL DEFAULT NULL AFTER `decription_font_family`, ADD `address` TEXT NULL DEFAULT NULL AFTER `description_font_color`, ADD `address_font_family` VARCHAR(255) NULL DEFAULT NULL AFTER `address`, ADD `address_font_color` VARCHAR(255) NULL DEFAULT NULL AFTER `address_font_family`, ADD `address_icon` VARCHAR(255) NULL DEFAULT NULL AFTER `address_font_color`, ADD `working_hours` VARCHAR(255) NULL DEFAULT NULL AFTER `address_icon`, ADD `working_hours_font_size` VARCHAR(255) NULL DEFAULT NULL AFTER `working_hours`, ADD `working_hours_font_family` VARCHAR(255) NULL DEFAULT NULL AFTER `working_hours_font_size`, ADD `working_hours_font_color` VARCHAR(255) NULL DEFAULT NULL AFTER `working_hours_font_family`, ADD `working_hours_icon` VARCHAR(255) NULL DEFAULT NULL AFTER `working_hours_font_color`, ADD `contact_number` VARCHAR(255) NULL DEFAULT NULL AFTER `working_hours_icon`, ADD `contact_font_family` VARCHAR(255) NULL DEFAULT NULL AFTER `contact_number`, ADD `contact_font_size` VARCHAR(255) NULL DEFAULT NULL AFTER `contact_font_family`, ADD `contact_font_color` VARCHAR(255) NULL DEFAULT NULL AFTER `contact_font_size`, ADD `contact_icon` VARCHAR(255) NULL DEFAULT NULL AFTER `contact_font_color`, ADD `email` VARCHAR(255) NULL DEFAULT NULL AFTER `contact_icon`, ADD `email_font_color` VARCHAR(255) NULL DEFAULT NULL AFTER `email`;

-- Disha : 17-10-2024 11:27 AM
ALTER TABLE `used_cars` ADD `email_font_size` VARCHAR(255) NULL DEFAULT NULL AFTER `email_font_color`, ADD `email_font_family` VARCHAR(255) NULL DEFAULT NULL AFTER `email_font_size`, ADD `email_icon` VARCHAR(255) NULL DEFAULT NULL AFTER `email_font_family`, ADD `facility_title` VARCHAR(255) NULL DEFAULT NULL AFTER `email_icon`, ADD `facility_title_font_size` VARCHAR(255) NULL DEFAULT NULL AFTER `facility_title`, ADD `facility_title_font_family` VARCHAR(255) NULL DEFAULT NULL AFTER `facility_title_font_size`, ADD `facility_title_font_color` VARCHAR(255) NULL DEFAULT NULL AFTER `facility_title_font_family`, ADD `customer_gallery_title` VARCHAR(255) NOT NULL AFTER `facility_title_font_color`, ADD `customer_gallery_title_color` VARCHAR(255) NULL DEFAULT NULL AFTER `customer_gallery_title`, ADD `customer_gallery_title_font_size` VARCHAR(255) NULL DEFAULT NULL AFTER `customer_gallery_title_color`, ADD `customer_gallery_title_font_family` VARCHAR(255) NULL DEFAULT NULL AFTER `customer_gallery_title_font_size`, ADD `testimonial_title` VARCHAR(255) NULL DEFAULT NULL AFTER `customer_gallery_title_font_family`, ADD `testimonial_title_color` VARCHAR(255) NULL DEFAULT NULL AFTER `testimonial_title`, ADD `testimonial_title_font_size` VARCHAR(255) NULL DEFAULT NULL AFTER `testimonial_title_color`, ADD `testimonial_title_font_family` VARCHAR(255) NULL DEFAULT NULL AFTER `testimonial_title_font_size`, ADD `lets_connect_image` VARCHAR(255) NULL DEFAULT NULL AFTER `testimonial_title_font_family`, ADD `address_title` VARCHAR(255) NULL DEFAULT NULL AFTER `lets_connect_image`, ADD `address_title_color` VARCHAR(255) NULL DEFAULT NULL AFTER `address_title`, ADD `address_title_font_size` VARCHAR(255) NULL DEFAULT NULL AFTER `address_title_color`, ADD `address_title_font_family` VARCHAR(255) NULL DEFAULT NULL AFTER `address_title_font_size`;
ALTER TABLE `used_cars` ADD `working_hour_title` VARCHAR(255) NULL DEFAULT NULL AFTER `address_title_font_family`, ADD `working_hour_title_color` VARCHAR(255) NULL DEFAULT NULL AFTER `working_hour_title`, ADD `working_hour_title_font_size` VARCHAR(255) NULL DEFAULT NULL AFTER `working_hour_title_color`, ADD `working_hour_title_font_family` VARCHAR(255) NULL DEFAULT NULL AFTER `working_hour_title_font_size`, ADD `contact_title` VARCHAR(255) NULL DEFAULT NULL AFTER `working_hour_title_font_family`, ADD `contact_title_color` VARCHAR(255) NULL DEFAULT NULL AFTER `contact_title`, ADD `contact_title_font_size` VARCHAR(255) NULL DEFAULT NULL AFTER `contact_title_color`, ADD `contact_title_font_family` VARCHAR(255) NULL DEFAULT NULL AFTER `contact_title_font_size`, ADD `email_title` VARCHAR(255) NULL DEFAULT NULL AFTER `contact_title_font_family`, ADD `email_title_color` VARCHAR(255) NULL DEFAULT NULL AFTER `email_title`, ADD `email_title_font_size` VARCHAR(255) NULL DEFAULT NULL AFTER `email_title_color`, ADD `email_title_font_family` VARCHAR(255) NULL DEFAULT NULL AFTER `email_title_font_size`;
ALTER TABLE `used_cars` ADD `brand_id` INT(11) NULL DEFAULT NULL COMMENT '\'id\' of \'brands\'' AFTER `business_id`, ADD `car_model_id` VARCHAR(255) NULL DEFAULT NULL COMMENT '\'id\' of \'cars\'' AFTER `brand_id`;

-- Disha : 17-10-2024 03:22 PM
ALTER TABLE `used_cars` CHANGE `decription_font_family` `description_font_family` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;
...
-- Disha : 18-10-2024 04:13 PM
ALTER TABLE `body_shops` ADD `car_model_id` VARCHAR(255) NULL DEFAULT NULL AFTER `business_id`;
ALTER TABLE `body_shops` ADD `description` TEXT NULL DEFAULT NULL AFTER `map_link`, ADD `description_font_size` VARCHAR(255) NULL DEFAULT NULL AFTER `description`, ADD `description_font_family` VARCHAR(255) NULL DEFAULT NULL AFTER `description_font_size`, ADD `description_font_color` VARCHAR(255) NULL DEFAULT NULL AFTER `description_font_family`;

-- Disha : 18-10-2024 04:33 PM
