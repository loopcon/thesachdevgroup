...
<section id="loaction-wise-map">
  ...
  <div class="row" style="margin-right:0px ; margin-left:0px">
    ...
    .nav-tabs-divider .nav-item:not(:last-child) {
        border-right: 1px solid #ccc; /* Change the color as needed */
    }
...
<article class="job-card"><div class="row"><div class="col-sm-4">
  ...
  <div class="job-title">GALAXY TOYOTA (SALES) - SHALIMAR PLACE</div>
  ...
  <div class="btn-container">
    <button class="apply">Click Here</button>
        ...
        <div class="col-sm-8">
                  <div class="job-title">GALAXY TOYOTA (SALES) - MOTINAGAR</div> 
...
New Delhi 110015</div>
   ...
   <article class="job-card"><div class="row"><div class="col-sm-4">
        ...
        <div class="col-sm-8">
                  <div class="job-title">GALAXY TOYOTA (SALES) - LAJPAT NAGAR</div> 
                  <div class="company-name">9A, Ring Rd, opposite Moolchand Medicity, Vikram Vihar, Lajpat Nagar IV, Sunlight Colony, New Delhi, Delhi 110024</div>
                  </div>
                  </div>
                  <div class="skills-container">
...
<article class="job-card"><div class="row"><div class="col-sm-4">
        ...
        <div class="col-sm-8">
                  <div class="job-title">GALAXY TOYOTA (SALES) - DWARKA</div> 
                  <div class="company-name">Plot No. 23, Sector 20, Marbel Market Metro Station Near Dwarka Sector 9, Dwarka</div>
 ...
 <a class="nav-link mb-0 p-0 left-location location-anchore" id="v-pills-settings-tab" data-toggle="pill" href="#dwarka-sales" role="tab" aria-controls="v-pills-settings" aria-selected="false">
      ...
      <article class="job-card"><div class="row"><div class="col-sm-4">
        ...
        <div class="col-sm-8">
                  <div class="job-title">GALAXY TOYOTA (SALES) - CHHATARPUR</div> 
                  <div class="company-name">  G1, Station Box Chattarpur Metro Station, Mehrauli-Gurgaon Rd, New Delhi, Delhi 110070</div>
                  </div>
                  </div>
                  <div class="skills-container">
