                                                                ...
                                                                @foreach($our_business as $business)
                                                                    <li>
                                                                        <button class="btns btns--ghost">
                                                                            <a class="nav-link" href="#tab_default_1" data-toggle="tab">{{$business->title}}</a>
                                                                        </button>
                                                                    </li>
                                                                @endforeach 
                                                                {{-- <li>
                                                            ...
                                                            <div class="mobile-wrapper">
                                                                @foreach ($showrooms as $showroom)
                                                                    <article class="job-card">
                                                                        ...
                                                                        <div class="skills-container">
                                                                            <p class="mobile-font-color">Mobile Number: <a href="tel:+91 {{$showroom->contact_number}}">+91 {{$showroom->contact_number}}</a></p>
                                                                ...
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="job-title">GALAXY TOYOTA (SERVICE) - KUNDLI</div> 
                                                                ...
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="job-title">GALAXY TOYOTA (SERVICE) - AZADPUR</div> 
                                                                ...
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8"> 
                                                                            <div class="job-title">GALAXY TOYOTA (SERVICE) - MOTINAGAR</div> 
                                                                ...
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="job-title">GALAXY TOYOTA (SERVICE) - OKHLA</div> 
                                                                            <div class="company-name">F-84, Okhla Okhla Phase I, Okhla Industrial Area New Delhi 110020</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="job-title">
                                                            ...
                                                            <div class="mobile-wrapper">
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="job-title">HANS HYUNDAI (SALES) - MOTINAGAR</div>
                                                                ...
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        <div class="col-sm-4">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="job-title">HANS HYUNDAI (SERVICE) - BADLI</div> 
                                                                ...
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="job-title">HANS HYUNDAI (SERVICE) - MOTINAGAR</div> 
                                                                ...
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="job-title">HANS HYUNDAI (SERVICE) - NARAINA</div> 
                                                                ...
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="job-title">HANS HYUNDAI (BODYSHOP) - Zakhira</div> 
                                            ...
                                            <div class="container py-4" style="max-width: -webkit-fill-available;">
                                                <div class="row">
                                                            ...
                                                            <div class="mobile-wrapper">
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="job-title">HARPREET FORD (SERVICE) -OKHLA</div>
                                                                ...
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="job-title">HARPREET FORD (SERVICE) -SAHIBABAD</div> 
                                                                ...
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="job-title">HARPREET FORD (SERVICE) - MOTINAGAR</div> 
                                                                ...
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="job-title">HARPREET FORD (SERVICE) -JAHANGIRPURI</div> 
                                                                ...
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="job-title">HARPREET FORD (SERVICE) - GURGAON</div> 
                                                                ...
                                                                <article class="job-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="job-title">HARPREET FORD (BODYSHOP) -KUNDLI</div> 
                                                    ...
                                                    <div class="col-md-7">
                                                        <!-- Tabs content -->
                                                        <div class="tab-content" id="v-pills-tabContent">
                                                            <div class="tab-pane fade rounded bg-white show active" id="harpreet-service-okhla" role="tabpanel" aria-labelledby="v-pills-home-tab">
