...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('used-car-contact-query-update', array('id' => encrypt($record->id))) }}" method="post" class="service-form" enctype="maltipart/form-data" data-parsley-validate="">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <a href="{{ route('used-car-contact-query') }}" class="btn btn-danger">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
