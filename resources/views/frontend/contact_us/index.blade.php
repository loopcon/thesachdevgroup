    ...
    <div class="contact-address-box row">
        <div class="col-md-3" style="margin-top: 15px; margin-bottom: 15px;">
            <div class="card">
                ...
                {{-- <h3 style="margin-top:45px; margin-bottom:10px ; font-size:22px;">69, Unit-2, TSG Complex 69, Najafgarh Rd, Moti Nagar, Crossing, New Delhi, Delhi 110015</h3> --}}
                @php($setting = getSettingDetail())
                <h3 style="margin-top:45px; margin-bottom:10px; color:{{$setting->address_color}}; font-size:{{$setting->address_font_size}}; font-family:{{$setting->address_font_family}};">
                    {{$setting->address}}
                </h3>

                <a href="mailto:info@thesachdevgroup.com">ðŸ“§ info@thesachdevgroup.com</a>
                <a href="">ðŸ“± +9170000000</a>
                <a href="">&#128188 09:00 - 06:30</a>
