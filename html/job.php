...
<?php  $title="Careers | Job at The Sachdev Group

"; ?>
<?php $description= "Looking for latest job openings at The Sachdev Group in Delhi, check out our The Sachdev Group careers page to know various job vacancies across departments."; ?>
...
<!--<section id="job-opning">-->
<!--  <div class="container">-->
  

<!-- <div class="vacancies-parent">-->
<!--  <div class="vacancie-one">-->
<!--    <div class="vacancie-text">-->
<!--      <div class="text-position">-->
<!--      <p>Digital Marketing Intern</p>-->
<!--       <a href="">Start your Carrer</a> -->
<!--      </div>-->
<!--      <div class="apply-now-button">-->
<!--      <a href="#carrer-form">Apply Now</a>-->
<!--    </div>-->
<!--    </div>-->
<!--  </div>-->
...
<!--<section id="advantage-to-join">-->
<!--  <div class="container">-->
<!--    <div class="carrer-offer">-->
<!--      <h2>What we Offer?</h2>-->
<!--    </div>-->
<!--    <div class="offer-point-parent">-->
<!--      <div class="point-one">-->
<!--      <div class="point-image">-->
<!--        <img src="assets/images/new-image/Group 22.png" alt="" width="70px">-->
<!--      </div>-->
<!--      <div class="point-text">-->
<!--          <h3><i class="fa fa-volume-up" aria-hidden="true"></i> Everyone has a Voice</h3>-->
<!--          <p>The Sachdev Group is committed to providing an open environment for creativity, ideas, and innovation.</p>-->
<!--      </div>-->
<!--      </div>-->
<!--      <div class="point-one">-->
<!--        <div class="point-image">-->
<!--  <img src="assets/images/new-image/Group 24.png" alt="" width="70px">-->
<!--      </div>-->
<!--      <div class="point-text">-->
<!--        <h3><i class="fa fa-line-chart" aria-hidden="true"></i> Room to Grow</h3>-->
<!--        <p>Grow on your career path with exciting learning opportunities at The Sachdev Group.</p>-->
<!--      </div>-->
<!--        </div>-->
<!--        <div class="point-one">  -->
<!--        <div class="point-image"> -->
<!--        <img src="assets/images/new-image/Group 23.png" alt="" width="70px">   -->
<!--      </div>     -->
<!--      <div class="point-text">    -->
<!--        <h3><i class="fa fa-arrows" aria-hidden="true"></i>Positivity is a Value</h3>-->
<!--        <p>We provide a positive and inclusive environment to help you achieve your goals with us.</p>-->
<!--      </div>-->
<!--        </div>-->
<!--        <div class="point-one">-->
<!--        <div class="point-image">-->
<!--        <img src="assets/images/new-image/Group 21.png" alt="" width="70px">-->
<!--      </div>-->
<!--      <div class="point-text">-->
<!--        <h3><i class="fa fa-smile-o" aria-hidden="true"></i>Let Us Grow Together</h3>-->
<!--        <p>At The Sachdev Group, we believe in collective growth, hence, combining our goals with your goals.</p>-->
<!--      </div>-->
<!--        </div>-->
<!--    </div>-->
     ...
     <div class="searched-jobs">
      ...
      <div class="job-cards">
       <div class="job-card">
        ...
        <div class="job-card-title">Automotive Technician
</div>
        <div class="job-card-subtitle">
An automotive technician will diagnose and repair vehicle issues, perform maintenance tasks, and ensure vehicles meet safety and performance standards.
        </div>
       ...
       <div class="job-card">
        ...
        <div class="job-card-subtitle">
A sales associate will engage with customers, assist in vehicle selection, provide information on features and financing, and facilitate test drives.
        </div>
        <div class="job-detail-buttons">
         <button class="search-buttons detail-button">Full Time</button>
         <button class="search-buttons detail-button">Min. 1 Year</button>
       ...
       <div class="job-card">
        ...
        <div class="job-card-title">Service Advisor
</div>
        <div class="job-card-subtitle">
A service advisor will assess vehicle issues, provide repair recommendations, schedule service appointments, and communicate updates throughout the repair process.        </div>
        <div class="job-detail-buttons">
         <button class="search-buttons detail-button">Full Time</button>
         <button class="search-buttons detail-button">Min. 1 Year</button>
         <button class="search-buttons detail-button">Senior Level</button>
       ...
       <div class="job-card">
        ...
        <div class="job-card-title">Parts Specialist
</div>
        <div class="job-card-subtitle">
A parts specialist will assist customers in finding the correct automotive parts, process orders, manage inventory, and provide product knowledge and recommendations.
        </div>
        <div class="job-detail-buttons">
         <button class="search-buttons detail-button">Full Time</button>
         <button class="search-buttons detail-button">Min. 1 Year</button>
        ...
        <div class="job-card-title">Customer Service Representative
</div>
        <div class="job-card-subtitle">
A customer service representative will assist customers with inquiries, resolve complaints, and provide information about products and services.
